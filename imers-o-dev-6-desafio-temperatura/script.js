var escala = parseInt(
  prompt(
    "Em qual escala de temperatura deseja converter? Escolha entre: 1 - celsius/ 2 - kelvin/ 3 - fahrenheit"
  )
);

var temperatura = parseInt(prompt("Quantos graus quer converter?"));
